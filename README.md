...
Этот проект создан при помощи AI (Claude/OpenAI) под полным ручным контролем человека. 100% кода написано и проверено человеком — AI использовался как ассистент для ускорения разработки, генерации шаблонов и поиска решений.
