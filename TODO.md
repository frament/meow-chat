...
## To Do
- [ ] #31 Ограничить высоту миниатюр аватаров пользователей в списке друзей и чатах
- [ ] #32 Редактор аватара: выбор части картинки для аватара (crop/zoom)
- [ ] #33 Markdown для сообщений и постов
